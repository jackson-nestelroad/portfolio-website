...
exports.Projects = [{
  ...
  external: null,
  details: ['Currently in development!', 'Implemented with C# and ASP.NET Core MVC.', 'Streams continuous data with SignalR.', 'Deployed to Microsoft Azure with SQL Server.']
}, {
