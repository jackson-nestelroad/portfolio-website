  ...
  function load() {
    ...
    return new Promise(function (resolve, reject) {
      if (document.readyState === 'complete') {
        ...
        document.addEventListener('DOMContentLoaded', function () {
          document.removeEventListener('DOMContentLoaded', _this);
          resolve(document);
        });
      }
    });
