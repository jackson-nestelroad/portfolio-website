...
exports.Projects = [{
  ...
  external: null,
  details: ['Implemented with C++ using the Boost.Asio library.', 'Multithreaded HTTP/HTTPS parsing, forwarding, and interception.', 'Custom certificate authority and certificate generation with OpenSSL.']
}, {
  name: 'AR Sphere',
  color: '#DB4F54',
  image: 'ar-sphere.jpg',
