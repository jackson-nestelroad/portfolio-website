...
exports.Projects = [{
  ...
  external: null,
  details: ['Team entrepreneurial project under ACM Ignite.', 'Implemented with C# and ASP.NET Core MVC.', 'Streams continuous data and real-time updates with SignalR.', 'Saves geographical data with Azure Spatial Anchors.', 'Deployed to Microsoft Azure with SQL Server and Blob Storage.']
}, {
