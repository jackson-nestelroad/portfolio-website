...
var Education = function (_super) {
  ...
  Education.prototype.createElement = function () {
    ...
    return JSX_1.ElementFactory.createElement("div", {
      ...
      src: "./images/Education/" + this.data.image
    })), JSX_1.ElementFactory.createElement("div", {
...
var Experience = function (_super) {
  ...
  Experience.prototype.createElement = function () {
    return JSX_1.ElementFactory.createElement("div", {
      ...
      src: "./images/Experience/" + this.data.svg + ".svg"
    }))), JSX_1.ElementFactory.createElement("div", {
      className: "company"
    }, JSX_1.ElementFactory.createElement("a", {
      href: this.data.link,
...
var Skill = function (_super) {
  ...
  Skill.prototype.created = function () {
    ...
    SVG_1.SVG.loadSVG("./images/Skills/" + this.data.svg).then(function (svg) {
  ...
  Skill.initialize = function () {
    return new Promise(function (resolve, reject) {
      if (Skill.HexagonSVG) {
        ...
        SVG_1.SVG.loadSVG('./images/Content/Hexagon').then(function (element) {
...
exports.Projects = [{
  ...
  external: null,
  details: ['Implemented with React, TypeScript, and SCSS.', 'Fully customizable wedding details and seating chart.', 'Flexible searching by first name, last name, full name, or tag.']
}, {
  name: 'DataJoint Core',
  color: '#51A8B9',
