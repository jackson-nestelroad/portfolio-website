...
function CreateLogoIE() {
  var SVGLocation = window.location.href + "out/images/Logo.svg";
  var request = new XMLHttpRequest();
  request.addEventListener('load', function () {
    var temp = document.createElement('x');
    temp.innerHTML = this.responseText;
    var svg = temp.getElementsByTagName('svg')[0];
    var parts = svg.getElementsByTagName('use');
    parts[0].setAttribute('class', 'outer preload');
    parts[1].setAttribute('class', 'inner preload');
    var container = DOM_1.DOM.getFirstElement('header.logo .image');
...
},{"../Modules/DOM":111,"../Modules/SVG":113,"../Modules/WebPage":114,"core-js/modules/es6.object.define-property":94}],110:[function(require,module,exports){
"use strict";
